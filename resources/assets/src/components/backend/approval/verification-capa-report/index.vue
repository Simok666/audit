<template> <div>
  ...
  <b-card header="View / Data Approval Verification Capa Report" header-tag="h4" class="mb-4">
      ...
      <template slot="Clause" slot-scope="props">
        ...
        <div class="custom-actions" v-if="props.rowData.Actived == 2 && props.rowData.StatusApproved == 1">
          <div v-if="props.rowData.ApprovedOrdinal == 0 && props.rowData.ApprovedOrdinal == props.rowData.OrdinalApproval">
            <b-btn class="btn btn-outline-success btn-sm mr-1 mt-1"
              @click="onAction('approve-item', props.rowData, props.rowIndex,0)" v-if="User.accessMenuDB[2].children[4].children[2].selected === true">
              <i class="ion ion-ios-create"></i> Approve
            </b-btn>
          </div>
          <div v-else-if="props.rowData.ApprovedOrdinal == 1 && props.rowData.ApprovedOrdinal == props.rowData.OrdinalApproval">
            <b-btn class="btn btn-outline-success btn-sm mr-1 mt-1"
              @click="onAction('approve-item', props.rowData, props.rowIndex,1)" v-if="User.accessMenuDB[2].children[4].children[2].selected === true">
              <i class="ion ion-ios-create"></i> Approve
            </b-btn>
            <b-btn class="btn btn-outline-danger btn-sm mr-sm-1 mt-1"
                @click="onAction('reject-item', props.rowData, props.rowIndex,1)" v-if="User.accessMenuDB[2].children[4].children[3].selected === true">
          ...
          <div v-else-if="props.rowData.ApprovedOrdinal == 2 && props.rowData.ApprovedOrdinal == props.rowData.OrdinalApproval">
            <b-btn class="btn btn-outline-success btn-sm mr-1 mt-1"
              @click="onAction('approve-item', props.rowData, props.rowIndex,2)" v-if="User.accessMenuDB[2].children[4].children[2].selected === true">
              <i class="ion ion-ios-create"></i> Approve
            </b-btn>
            <b-btn class="btn btn-outline-danger btn-sm mr-sm-1 mt-1"
                @click="onAction('reject-item', props.rowData, props.rowIndex,2)" v-if="User.accessMenuDB[2].children[4].children[3].selected === true">
                <i class="ion ion-md-warning"></i> Reject
            </b-btn>
          </div>
        </div>
