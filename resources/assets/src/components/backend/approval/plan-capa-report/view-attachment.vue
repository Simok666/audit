<template>
    <b-card header="Data File Attachment Plan Capa Report" header-tag="h4" class="mb-4 text-center">
        <div class="table-responsive">
            <table class="table table-bordered b-t">
                ...
                <tbody>
                    ...
                    <tr style="background-color:white" v-for="(item, i) in detailDataPreventive" :key="i">
                        <td>
                          <div v-if="i == 0">
                            {{i+2}}
                          </div>
