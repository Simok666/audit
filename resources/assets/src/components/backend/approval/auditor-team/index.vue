<template> <div>
  ...
  <b-card header="View / Data Approval Auditor Team" header-tag="h4" class="mb-4">
      ...
      <template slot="Path" slot-scope="props">
          <div v-if="props.rowData.Path != ''">
            ...
            @click="viewAttachment(props.rowData, props.rowIndex)" v-if="User.accessMenuDB[2].children[1].children[2].selected === true">
      ...
      <template slot="EmpApproved" slot-scope="props">
        ...
        <div class="custom-actions" v-if="props.rowData.Actived == 2">
          <div v-if="props.rowData.StatusApproved == 1 && props.rowData.StatusApprovedEmp == 1">
            <b-btn class="btn btn-outline-success btn-sm mr-1 mt-1"
              @click="onAction('approve-item', props.rowData, props.rowIndex,2)" v-if="User.accessMenuDB[2].children[1].children[3].selected === true">
              <i class="ion ion-ios-create"></i> Approve
            </b-btn>
            <b-btn class="btn btn-outline-danger btn-sm mr-sm-1 mt-1"
                @click="onAction('reject-item', props.rowData, props.rowIndex,2)" v-if="User.accessMenuDB[2].children[1].children[4].selected === true">
