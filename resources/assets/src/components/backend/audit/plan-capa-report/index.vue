<template> <div>
  ...
  <b-card header="View / Data Plan Capa Report" header-tag="h4" class="mb-4">
      ...
      <div class="col-md-6">
          ...
          <b-btn @click="createData()" class="btn btn-success btn-md float-right mr-2" v-if="User.accessMenuDB[1].children[3].children[0].selected === true">
      ...
      <!-- <template slot="Path" slot-scope="props">
          <div class="custom-path">
            ...
            @click="viewAttachment(props.rowData, props.rowIndex)" v-if="User.accessMenuDB[1].children[2].children[1].children[2].selected === true">
      ...
      <template slot="Clause" slot-scope="props">
        ...
        <template slot="Actions" slot-scope="props">
            <div class="custom-actions" v-if="props.rowData.Actived == 1">
                ...
                @click="onAction('edit-item', props.rowData, props.rowIndex,0)" v-if="User.accessMenuDB[1].children[3].children[0].selected === true && props.rowData.IsDepartment === true">
                <i class="ion ion-md-create"></i> Edit
                </b-btn>
                <b-btn class="btn btn-outline-danger btn-sm mr-1 mt-1"
                @click="onAction('delete-item', props.rowData, props.rowField,0)" v-if="User.accessMenuDB[1].children[3].children[1].selected === true && props.rowData.IsDepartment === true">
        ...
        <div class="custom-actions" v-if="props.rowData.Actived == 1">
          <b-btn class="btn btn-outline-success btn-sm mr-1 mt-1"
            @click="onAction('publish-item', props.rowData, props.rowIndex,0)" v-if="User.accessMenuDB[1].children[3].children[3].selected === true && props.rowData.IsDepartment === true">
        ...
        <div class="custom-actions" v-if="props.rowData.Actived == 2 && props.rowData.StatusApproved == 2">
          <b-btn class="btn btn-outline-warning btn-sm mr-1 mt-1"
            @click="onAction('reminder-item', props.rowData, props.rowIndex,0)" v-if="User.accessMenuDB[1].children[3].children[4].selected === true">
            <i class="ion ion-md-mail"></i> Send Remainder
          </b-btn>
        </div>
