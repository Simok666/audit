<template>
    <b-card header="Data File Attachment Auditor Report" header-tag="h4" class="mb-4 text-center">
...
export default {
  ...
  methods: {
      ...
      getNameFile(data){
        ...
        let NameFile = split[0].replace('clouds/backend/files/auditor-report/','')
        return NameFile;
      }
  },
