<template> <div>
  ...
  <b-card header="View / Data Kecamatan" header-tag="h4" class="mb-4">
      ...
      <div class="col-md-6">
          <!-- <b-dd variant="danger" class="float-right">
            ...
            <b-dropdown-item href="/AdminVue/district-export-pdf" target="_blank">PDF</b-dropdown-item>
      ...
      <template slot="tableHeader" slot-scope="props">
        <tr class="text-center">
          ...
          <th>
            <b-input v-model="paramData.search.cty__Name" placeholder="Kota" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.usr__UserName" placeholder="User Entry" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
