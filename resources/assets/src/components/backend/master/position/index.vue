<template> <div>
  ...
  <b-card header="View / Data Position" header-tag="h4" class="mb-4">
      ...
      <div class="col-md-6">
          ...
          <b-btn @click="createData()" class="btn btn-success btn-md float-right mr-2" v-if="User.accessMenuDB[0].children[3].children[0].selected === true">
      ...
      <template slot="tableHeader">
        <tr class="text-center">
          <th class="wd-50"></th>
          <th>
            <b-input v-model="paramData.search.pst__Code" placeholder="Code" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.dvs__Department" placeholder="Division" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.dpt__Department" placeholder="Departement" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.psp__Name" placeholder="Parent" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.pst__Name" placeholder="Position" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
           <b-input v-model="paramData.search.pst__JobDesk" placeholder="JobDesk" v-on:keyup.enter="getFilters()" />
          </th>
          <th></th>
          <!-- <th></th> -->
        </tr>
      ...
      <template slot="index" slot-scope="props">
        ...
        <div class="custom-actions">
          ...
          <b-btn class="btn btn-outline-secondary btn-sm mr-1 mt-1"
            @click="onAction('edit-item', props.rowData, props.rowIndex)" v-if="User.accessMenuDB[0].children[3].children[0].selected === true">
            <i class="ion ion-md-create"></i> Edit
          </b-btn>
          <b-btn class="btn btn-outline-danger btn-sm mr-1 mt-1"
            @click="onAction('delete-item', props.rowData, props.rowIndex)" v-if="User.accessMenuDB[0].children[3].children[1].selected === true">
