<template> <div>
  ...
  <b-card header="View / Data Template Email" header-tag="h4" class="mb-4">
      ...
      <div class="col-md-6">
          ...
          <b-btn @click="createData()" class="btn btn-success btn-md float-right mr-2" v-if="User.accessMenuDB[0].children[10].children[0].selected === true">
      ...
      <template slot="tableHeader">
        <tr class="text-center">
          <th class="wd-50"></th>
          <th>
            <b-input v-model="paramData.search.oag__Name" placeholder="Organizer" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.emt__Subject" placeholder="Subject" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.emt__Body" placeholder="Body" v-on:keyup.enter="getFilters()" />
          </th>
          <th></th>
          <!-- <th></th> -->
        </tr>
