<template> <div>
  ...
  <b-card header="View / Data Domain" header-tag="h4" class="mb-4">
      ...
      <template slot="tableHeader">
        <tr class="text-center">
          <th class="wd-50"></th>
          <th>
            <b-input v-model="paramData.search.adm__Name" placeholder="Domain" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.adm__Description" placeholder="Description" v-on:keyup.enter="getFilters()" />
          </th>
          <th></th>
          <th>
            <masked-input type="text" class="form-control" placeholder="Thn-Bln-Tgl"
              v-model="paramData.search.adm__UpdateAt"
