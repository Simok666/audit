(self["webpackChunkaudit_widatra"] = self["webpackChunkaudit_widatra"] || []).push([["resources_assets_src_components_backend_audit_auditor-report_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************/
  ...
  data: function data() {
    return {
      fields: [{
        ...
        sortField: 'adr.PotentialNonConformitiy',
        title: 'Potential Non Conformity',
        titleClass: 'text-center',
        dataClass: 'text-center'
      }, {
        name: 'TypeNonConformity',
        sortField: 'adr.TypeNonConformity',
  ...
  methods: {
    ...
    onAction: function onAction(action, data, index, ordinal) {
      ...
      if (action == 'delete-item') {
        this.deleteData('/AdminVue/auditor-report-delete', data.id, this.$refs.vuetable);
      }
      if (action == 'publish-item') {
        this.publishData('/AdminVue/auditor-report-publish', data.id, this.$refs.vuetable);
      }
      if (action == 'close-item') {
        this.closeData('/AdminVue/auditor-report-close', data.id, this.$refs.vuetable);
      }
      if (action == 'approve-item') {
        this.appData('/AdminVue/auditor-report/' + ordinal + '/approveData', data.id, this.$refs.vuetable, 1);
      }
      if (action == 'reject-item') {
        this.appData('/AdminVue/auditor-report/' + ordinal + '/rejectData', data.id, this.$refs.vuetable, 2);
      }
    },
    createData: function createData() {
      this.$router.push('/RoleAdmin/audit/form-auditor-report');
    }
  },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=template&id=f7e1afe2&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=template&id=f7e1afe2& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", [_c("b-card", {
    ...
    staticClass: "col-md-6"
  }, [_vm.User.accessMenuDB[1].children[2].children[0].selected === true ? _c("b-btn", {
    ...
    ref: "vuetable",
    attrs: {
      "api-url": "/AdminVue/data-auditor-report",
    ...
    scopedSlots: _vm._u([{
      ...
      key: "Path",
      fn: function fn(props) {
        return [props.rowData.Path != "" ? _c("div", [_vm.User.accessMenuDB[1].children[2].children[2].selected === true ? _c("b-btn", {
      ...
      fn: function fn(props) {
        ...
        }), _vm._v(" Show\n                ")]), _vm._v(" "), _vm.User.accessMenuDB[1].children[2].children[0].selected === true && props.rowData.CekAuditor == true ? _c("b-btn", {
        ...
        }), _vm._v(" Edit\n                ")]) : _vm._e(), _vm._v(" "), _vm.User.accessMenuDB[1].children[2].children[1].selected === true && props.rowData.CekAuditor == true ? _c("b-btn", {
          staticClass: "btn btn-outline-danger btn-sm mr-1 mt-1",
          on: {
            click: function click($event) {
      ...
      fn: function fn(props) {
        return [props.rowData.Actived == 1 ? _c("div", {
          staticClass: "custom-actions"
        }, [_vm.User.accessMenuDB[1].children[2].children[4].selected === true && props.rowData.CekAuditor == true ? _c("b-btn", {
          ...
          staticClass: "custom-actions"
        }, [_vm.User.accessMenuDB[1].children[2].children[3].selected === true ? _c("a", {
          staticClass: "btn btn-xs btn-outline-danger text-danger",
          attrs: {
            href: "/AdminVue/auditor-report/" + props.rowData.id + "/exportStatusAudit",
            target: "_blank"
          }
        }, [_c("i", {
          staticClass: "fas fa-print"
        }), _vm._v(" Export Status Audit")]) : _vm._e(), _vm._v(" "), props.rowData.IsCapaPlan != 1 && props.rowData.CekAuditor == true ? _c("b-btn", {
          staticClass: "btn btn-outline-danger btn-sm mr-1 mt-1",
          on: {
            click: function click($event) {
              return _vm.onAction("close-item", props.rowData, props.rowIndex);
            }
          }
        }, [_c("i", {
    ...
    model: {
      value: _vm.paramData.search.adr__NoTrans,
      callback: function callback($$v) {
        _vm.$set(_vm.paramData.search, "adr__NoTrans", $$v);
      },
      expression: "paramData.search.adr__NoTrans"
    }
    ...
    model: {
      value: _vm.paramData.search.adr__AuditorDate,
      callback: function callback($$v) {
        _vm.$set(_vm.paramData.search, "adr__AuditorDate", $$v);
      },
      expression: "paramData.search.adr__AuditorDate"
    }
  })], 1), _vm._v(" "), _c("th", [_c("b-input", {
    attrs: {
    ...
    model: {
      value: _vm.paramData.search.adr__PotentialNonConformitiy,
      callback: function callback($$v) {
        _vm.$set(_vm.paramData.search, "adr__PotentialNonConformitiy", $$v);
      },
      expression: "paramData.search.adr__PotentialNonConformitiy"
    }
  })], 1), _vm._v(" "), _c("th", [_c("b-input", {
    attrs: {
    ...
    model: {
      value: _vm.paramData.search.adr__TypeNonConformity,
      callback: function callback($$v) {
        _vm.$set(_vm.paramData.search, "adr__TypeNonConformity", $$v);
      },
      expression: "paramData.search.adr__TypeNonConformity"
    }
...
/***/ "./resources/assets/src/components/backend/audit/auditor-report/index.vue":
/*!********************************************************************************!*\
  !*** ./resources/assets/src/components/backend/audit/auditor-report/index.vue ***!
  \********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_f7e1afe2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=f7e1afe2& */ "./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=template&id=f7e1afe2&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_f7e1afe2___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_f7e1afe2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/src/components/backend/audit/auditor-report/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************!*\
  !*** ./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=template&id=f7e1afe2&":
/*!***************************************************************************************************************!*\
  !*** ./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=template&id=f7e1afe2& ***!
  \***************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_f7e1afe2___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_f7e1afe2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_f7e1afe2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=f7e1afe2& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/src/components/backend/audit/auditor-report/index.vue?vue&type=template&id=f7e1afe2&");
